...
| [009](tasks/009-high-pressure-vof-conservation.md) | 高压可压缩界面守恒（40–100 MPa） | P1 | **in-progress**（<1e-3 只到约 38 MPa；40 MPa hold 4.5e-2） | 006 | 1–2 周 |
...
| [018a](tasks/018a-shrinkage-void-model.md) | 封冻后收缩空洞/负压建模（018 拆分） | P1 | **in-progress**（阶段 1–3：指标 + `voidFraction` 场 + 精确 Tait EOS + 密封冷却用例 18/18；张力限制/守恒待做） | 018 | 1–2 周 |
