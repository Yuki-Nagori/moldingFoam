...
) const
{
    ...
    // The 0.1 lambda cap favours temporal accuracy over a small amount of
    // extra local work, which is important for stress feedback.
    const label estimatedSub = static_cast<label>(ceil(dt/(0.1*lambda_)));
