...
| [044](tasks/044-parameter-coverage-strength.md) | 参数覆盖补齐与模式-only 用例强化（pressureRamp 等） | P2 | in-progress（潜热断言与 cycleReset 数值验证器已交付；pressureRamp 三路径、gateFreeze、powerLaw/Nu 待做） | 038/006/012/016 |
